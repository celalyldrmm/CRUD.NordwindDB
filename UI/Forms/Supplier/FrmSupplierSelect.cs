using BusinessLayer;
using CRUDNordwindDB.TypeLayer;
using System;
...
namespace CRUDNordwindDB.UI.Forms.Supplier
{
    public partial class FrmSupplierSelect : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Common_Messages.liste_secim_yapılmadı);
            }
        }
        ...
        private void list_Supplier_List_SelectedIndexChanged(object sender, EventArgs e)
        {
